...
use crate::raydium::serum_types::{EventView, MarketState, OpenOrders, Side, ToAlignedBytes};
use num_traits::CheckedDiv;
use solana_program::{account_info::AccountInfo, log::sol_log_compute_units, msg};
use std::{cmp::Eq, convert::TryInto, convert::identity};
...
impl Calculator {
    ...
    */
    ...
    pub fn get_max_buy_size_at_price(price: u64, x: u128, y: u128, amm: &RaydiumAmmInfo) -> u64 {
    ...
    pub fn get_max_sell_size_at_price(price: u64, x: u128, y: u128, amm: &RaydiumAmmInfo) -> u64 {
